...
# Link to reddit: http://www.reddit.com/r/dailyprogrammer/comments/21w3lb/412014_challenge_156_easy_simple_decoder/

# Difficulty: Easy

# Description:
# To honor our mistake this week's easy challenge is to decode a message. I have encoded a message by adding a "4" to
# each character's ASCII value. It will be your job to decode this message by reversing the process and making a
# decoder.
...
line = [[print(str(chr(ord(letter) - 4)), end='') for letter in line] for line in encoded]
